public class CatHouse {
    ...
    public void rollCall() {
        ...
        || (cat1.getAge() == cat2.getAge() && cat1.getName().equals(cat2.getName()))
        || (cat1.getAge() == cat2.getAge() && cat1.getName().compareTo(cat2.getName()) < 0)) {
            cat1.introduce();
            cat2.introduce();
        } else if (cat1.getAge() < cat2.getAge() || (cat1.getAge() == cat2.getAge() && cat1.getName().compareTo(cat2.getName()) > 0)) {
            cat2.introduce();
            cat1.introduce();
        }
    }
